...
/**
    ...
    public static function getStatusText() {
        ...
        $status = TencentYouTuHttp::info()['http_code'];
    ...
    public static function detectface($image_path, $isbigface) {
        ...
        $postUrl = TencentYouTuConf::$END_POINT . 'youtu/api/detectface';
        $sign = TencentYouTuAuth::appSign($expired, TencentYouTuConf::$USER_ID);

        $image_data = file_get_contents($real_image_path);
        $post_data = array(
            "app_id" =>  TencentYouTuConf::$APPID,
    ...
    public static function faceshape($image_path, $isbigface) {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = TencentYouTuConf::$END_POINT . 'youtu/api/faceshape';
        $sign = TencentYouTuAuth::appSign($expired, Conf::$USER_ID);
   ...
   /**
    ...
    public static function facecompare($image_path_a, $image_path_b) {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = TencentYouTuConf::$END_POINT . 'youtu/api/facecompare';
        $sign = TencentYouTuAuth::appSign($expired, Conf::$USER_ID);
    ...
    public static function faceverify($image_path,$person_id) {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = TencentYouTuConf::$END_POINT . 'youtu/api/faceverify';
        $sign = TencentYouTuAuth::appSign($expired, Conf::$USER_ID);
